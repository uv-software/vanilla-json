...
echo  *  Vanilla-JSON - Another very simple JSON Parser >> .\Sources\build_no.h
echo  * >> .\Sources\build_no.h
echo  *  Copyright (c) 2024 Uwe Vogt, UV Software, Berlin (info@uv-software.com) >> .\Sources\build_no.h
echo  *  All rights reserved. >> .\Sources\build_no.h
echo  * >> .\Sources\build_no.h
echo  *  This file is part of Vanilla-JSON. >> .\Sources\build_no.h
echo  * >> .\Sources\build_no.h
echo  *  Vanilla-JSON is dual-licensed under the BSD 2-Clause "Simplified" License >> .\Sources\build_no.h
echo  *  and under the GNU General Public License v3.0 (or any later version). You can >> .\Sources\build_no.h
echo  *  choose between one of them if you use Vanilla-JSON in whole or in part. >> .\Sources\build_no.h
echo  * >> .\Sources\build_no.h
...
echo  * >> .\Sources\build_no.h
echo  *  Vanilla-JSON IS PROVIDED BY THE COPYRIGHT HOLDERS AND CONTRIBUTORS "AS IS" >> .\Sources\build_no.h
...
echo  *  OF Vanilla-JSON, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGE. >> .\Sources\build_no.h
echo  * >> .\Sources\build_no.h
echo  *  GNU General Public License v3.0 or later: >> .\Sources\build_no.h
echo  *  Vanilla-JSON is free software: you can redistribute it and/or modify >> .\Sources\build_no.h
...
echo  * >> .\Sources\build_no.h
echo  *  Vanilla-JSON is distributed in the hope that it will be useful, >> .\Sources\build_no.h
...
echo  *  along with Vanilla-JSON.  If not, see "https://www.gnu.org/licenses/". >> .\Sources\build_no.h
echo  */ >> .\Sources\build_no.h
